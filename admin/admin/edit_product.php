...
if($picture_type=="image/jpeg" || $picture_type=="image/jpg" || $picture_type=="image/png" || $picture_type=="image/gif")
{
	if($picture_size<=50000000)
        ...
        move_uploaded_file($picture_tmp_name,"../../assets/products_images/".$pic_name);
            ...
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                    <img src='<?php echo "../../assets/products_images/".$pic_name?>' style='width:50px; height:50px; border:groove #000'>
                      <div class="">
