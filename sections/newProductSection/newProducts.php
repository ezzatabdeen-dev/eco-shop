...
<div class="container newProductsContainer">
    <div class="newProductsItems">
        <div class="newProdutsHeader">
            <h2 class="newProductsTitle text-5">New Products</h2>
            <div class="newProductsSliderControler">
                <span class="product-next"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"/></svg></span>
                <span class="product-prev"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path d="M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l192 192c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L77.3 256 246.6 86.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-192 192z"/></svg></span>
            </div>
        </div>
        
        <div class="swiper newProdutsSlider">
        ...
        <div class="hotDealItems">
            ...
            <div class="hotDealItem">
                <img src="assets/products_images/hotDeal1.png" alt="product">
                <div class="subbanner-heading">
                <p class="text-4"><strong style="font-weight: bold">Buy Comfortable</strong></p><p class="text-3" style="font-weight: 500">Wooden Chair</p>
                </div>
                <p class="text-3 supPrice" style="font-weight: 500">$150.00</p>
                <a class="text-2" style="font-weight: 400" href="#">Shop Now</a>
            </div>

            <div class="hotDealItem">
                <img src="assets/products_images/hotDeal2.png" alt="product">
                <div class="subbanner-heading">
                <p  class="text-4"><strong style="font-weight: bold">Biggest Deals </strong><br><p class="text-3" style="font-weight: 500">On Clothes</p></p>
                </div>
                <p class="text-3 supPrice" style="font-weight: 500">$170.00</p>
                <a class="text-2" style="font-weight: 400" href="#">Shop Now</a>
            </div>

            <div class="hotDealItem">
                <img src="assets/products_images/hotDeal3.png" alt="product">
                <div class="subbanner-heading">
                <p  class="text-4"><strong style="font-weight: bold">Best Quality </strong><br><p class="text-3" style="font-weight: 500">Controller</p></p>
                </div>
                <p class="text-3 supPrice" style="font-weight: 500">$180.00</p>
                <a class="text-2" style="font-weight: 400" href="#">Shop Now</a>
            </div>
